...
class Oba extends StatefulWidget {
  const Oba({super.key});

  @override
  State<Oba> createState() => _ObaState();
}

class _ObaState extends State<Oba> {


  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/1818105513':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('obahortifruti').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('obahortifruti').limit(1).snapshots();
