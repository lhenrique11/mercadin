...
class Lavapes extends StatefulWidget {
  const Lavapes({super.key});

  @override
  State<Lavapes> createState() => _LavapesState();
}

class _LavapesState extends State<Lavapes> {

  
final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/8779045781':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('lavapes').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('lavapes').limit(1).snapshots();
