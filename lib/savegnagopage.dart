...
class Savegnago extends StatefulWidget {
  const Savegnago({super.key});

  @override
  State<Savegnago> createState() => _SavegnagoState();
}

class _SavegnagoState extends State<Savegnago> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/7609488240':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('savegnago').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('savegnago').limit(1).snapshots();
