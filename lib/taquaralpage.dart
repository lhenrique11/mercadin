...
class Taquaral extends StatefulWidget {
  const Taquaral({super.key});

  @override
  State<Taquaral> createState() => _TaquaralState();
}

class _TaquaralState extends State<Taquaral> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/3526719103':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('taquaral').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('taquaral').limit(1).snapshots();
