...
final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/9505023840':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('sams').limit(1).snapshots();
              ...
              child: Column(
                ...
                children: [
                  ...
                  FadeIn(
                    ...
                    curve: Curves.easeIn,
                    child: Padding(
                      padding: const EdgeInsets.fromLTRB(0.0, 80.0, 260.0, 0.0),
                      child: Text('Sams Club', 
