...
class GoodBom extends StatefulWidget {
  const GoodBom({super.key});

  @override
  State<GoodBom> createState() => _GoodBomState();
}

class _GoodBomState extends State<GoodBom> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/3909862486':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('goodbom').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('goodbom').limit(1).snapshots();
