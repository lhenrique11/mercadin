...
class PagueMenos extends StatefulWidget {
  const PagueMenos({super.key});

  @override
  State<PagueMenos> createState() => _PagueMenosState();
}

class _PagueMenosState extends State<PagueMenos> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/5933444497':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('paguemenos').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('paguemenos').limit(1).snapshots();
