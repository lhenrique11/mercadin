...
class Covabra extends StatefulWidget {
  const Covabra({super.key});

  @override
  State<Covabra> createState() => _CovabraState();
}

class _CovabraState extends State<Covabra> {


  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/2584392271':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('covabra').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('covabra').limit(1).snapshots();
