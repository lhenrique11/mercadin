...
class Sonda extends StatefulWidget {
  const Sonda({super.key});

  @override
  State<Sonda> createState() => _SondaState();
}

class _SondaState extends State<Sonda> {


  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/8191942173':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('sonda').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('sonda').limit(1).snapshots();
