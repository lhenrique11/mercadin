...
class SaoVicente extends StatefulWidget {
  const SaoVicente({super.key});

  @override
  State<SaoVicente> createState() => _SaoVicenteState();
}

class _SaoVicenteState extends State<SaoVicente> {

final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/2329241403':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('saovicente').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('saovicente').limit(1).snapshots();
