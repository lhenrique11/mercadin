...
class Dalben extends StatefulWidget {
  const Dalben({super.key});

  @override
  State<Dalben> createState() => _DalbenState();
}

class _DalbenState extends State<Dalben> {


final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/5018983923':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('dalben').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('dalben').limit(1).snapshots();
