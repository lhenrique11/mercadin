...
class Carrefour extends StatefulWidget {
  const Carrefour({super.key});

  @override
  State<Carrefour> createState() => _CarrefourState();
}
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('carrefour').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('carrefour').limit(1).snapshots();
              ...
              child: Column(
                ...
                children: [
                  ...
                  FadeIn(
                    ...
                    curve: Curves.easeIn,
                    child: Padding(
                      padding: const EdgeInsets.fromLTRB(0.0, 80.0, 270.0, 0.0),
