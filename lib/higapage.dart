...
class Higa extends StatefulWidget {
  const Higa({super.key});

  @override
  State<Higa> createState() => _HigaState();
}

class _HigaState extends State<Higa> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/4827412239':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('higa').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('higa').limit(1).snapshots();
