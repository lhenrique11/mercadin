...
class Assai extends StatefulWidget {
  const Assai({super.key});

  @override
  State<Assai> createState() => _AssaiState();
}
...
class _AssaiState extends State<Assai> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('assai').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('assai').limit(1).snapshots();
