...
class _ArenaState extends State<Arena> {
  ...
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/1918355477':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('arena').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('arena').limit(1).snapshots();
