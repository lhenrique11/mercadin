...
class Atacadao extends StatefulWidget {
  const Atacadao({super.key});

  @override
  State<Atacadao> createState() => _AtacadaoState();
}

class _AtacadaoState extends State<Atacadao> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/1910385103':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('atacadao').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('atacadao').limit(1).snapshots();
