...
class MiniExtra extends StatefulWidget {
  const MiniExtra({super.key});

  @override
  State<MiniExtra> createState() => _MiniExtraState();
}

class _MiniExtraState extends State<MiniExtra> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/3642323071':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('miniextra').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('miniextra').limit(1).snapshots();
              ...
              child: Column(
                ...
                children: [
                  ...
                  FadeIn(
                    ...
                    curve: Curves.easeIn,
                    child: Padding(
                      padding: const EdgeInsets.fromLTRB(0.0, 80.0, 250.0, 0.0),
                      child: Text('Mini Extra', 
