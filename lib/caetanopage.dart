...
class Caetano extends StatefulWidget {
  const Caetano({super.key});

  @override
  State<Caetano> createState() => _CaetanoState();
}

class _CaetanoState extends State<Caetano> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/8092650078':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('caetano').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('caetano').limit(1).snapshots();
