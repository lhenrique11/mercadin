...
class Tenda extends StatefulWidget {
  ...
  @override
  State<Tenda> createState() => _TendaState();
}

class _TendaState extends State<Tenda> {

  final BannerAd myBanner = BannerAd(
  adUnitId: Platform.isAndroid ? 'ca-app-pub-4975130382486636/3307281151':
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('tenda').snapshots();
    final Stream<QuerySnapshot> destaqueStream =
    FirebaseFirestore.instance.collection('tenda').limit(1).snapshots();
